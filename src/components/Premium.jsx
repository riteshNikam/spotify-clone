...
const Premium = () => {
  ...
  return (
    <>
      {darkmodeFlag ? (
        <div
          className={`dark:bg-black dark:text-white flex flex-row justify-center items-center py-10`}
        >
        ...
        <div
          className={`bg-white text-black flex flex-row justify-center items-center py-10`}
        >
          <h1 className="self-center text-2xl font-bold mx-5">
            All Premium plans include
          </h1>
