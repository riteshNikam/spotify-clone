...
const Premium = () => {
    return (
        <>
            <div className="dark:bg-black dark:text-white flex flex-row justify-center pb-20">
                <h1 className="self-center text-2xl font-bold mx-5">All Premium plans include</h1>
