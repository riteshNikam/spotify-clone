  ...
  return (
    <>
      {darkmodeFlag ? (
        <div
          className={
            "px-16 dark:bg-black flex dark:text-green-700 flex-col h-[70vh] justify-center items-center"
          }
        >
        ...
        <div
          className={
            "px-16 flex text-green-700 flex-col h-[70vh] justify-center items-center"
          }
        >
          <h1 className="font-bold text-5xl">Stream Your Favourite Music</h1>
          <h1 className="font-bold text-5xl">Anytime, Anywhere with Spotify</h1>
