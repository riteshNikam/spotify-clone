...
const PremiumTable = () => {
    return (
        <>
            <div className="dark:bg-black dark:text-white flex flex-col items-center pb-20">
                <h1 className="text-4xl font-bold">Experience the difference</h1>
                <p className="text-lg font-medium">Go premium and enjoy full control of your listening.</p>
